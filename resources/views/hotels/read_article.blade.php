    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 mx-auto">
                <h2>記事の内容（閲覧者用）</h2>
                {{--<form action="{{ action('HotelController@read') }}" method="post" enctype="multipart/form-data">--}}
                <div class="main">
                    @if (count($errors) > 0)
                        <ul>
                   ...
                   @if ($hotel_form->image_main)
                        <img src="{{ asset('storage/image/' . $hotel_form->image_main) }}" class="hotel-list-row-image">
                    @endif
                    <div class="form-group row">
